# Brooks — Demo (v2, story-first rewrite)
...
Supersedes [demo-storyboard.md](demo-storyboard.md) (the "Brooks / earnings-call" v1). Same engine + CAVA
...
**Brooks is the analyst in your ear on a $1,200 expert call — it knows your model cold, watches the
...
new-unit stories in the group."* **Brooks catches the dodge, grounds it against Maya's own model ($2.6M),
...
- **Left — Must-ask, ranked by what your model needs most.** Not a checklist Maya brought — Brooks's own
...
- **Right — Brooks cards**, firing in real time: `Ask this` (the gap-closer), `Flag` (contradiction vs her note).
...
| 1 | 0:11–0:22 | Operator audio: *"…the new classes are opening strong — honestly one of the best new-unit stories in the group."* `Ask this` card fires | **Edison** | "He just glided past the one number her whole thesis rests on. Brooks caught it — grounded in *her* model, $2.6M AUV — and wrote the question." |
...
| 1 | 0:34–0:40 | `①` flips green; model delta animates `$2.6M → $2.4M` | **Edison** | "There it is. The number he wasn't going to volunteer — and her model just moved. **That's Brooks.**" |
| **THE TELL — now explain it** |
| 2 | 0:40–0:54 | Pull back to full layout; Moss indicator + clock highlighted | **Skyler** | "Here's how. Brooks knows Maya's filings and model cold. LiveKit transcribes live, Moss retrieves the matching assumption in milliseconds, and it surfaces only what her model can't survive without — ranked by impact, against the clock." |
| 3 | 0:54–1:06 | The must-ask rail, ranked | **Edison** | "Every quarter Maya buys a handful of these. The expert always talks; the clock always wins; the question she needed hits her in the parking lot. Brooks is the analyst in her ear that never forgets the model and never loses the time." |
...
| 5 | 1:22–1:34 | Clock at `~38:00`. Board: 4 of 5 model-critical answered; last one grey → Brooks nudge | **Edison** | "And it won't let her hang up with a model-critical question still open." |
...
| 8 | 1:53–2:00 | Cut to Multiplier with Brooks docked | **Skyler** | "Brooks ships inside Multiplier, to funds already paying us. **Buy the hour. Don't waste it.**" |
...
> **EDISON:** He just glided past the one number her whole thesis rests on. Brooks caught it — grounded in *her* model, $2.6 million AUV — and wrote the question.

> **SKYLER (live, into the call):** "What's the 2024 class actually opening at?" *[operator audio: "…around $2.4 million, not 2.6."]*

> **EDISON:** There it is. The number he wasn't going to volunteer — and her model just moved. That's Brooks.

> **SKYLER:** Here's how. Brooks knows Maya's filings and model cold. LiveKit transcribes live, Moss retrieves the matching assumption in milliseconds, and it surfaces only what her model can't survive without — ranked by impact, against the clock.

> **EDISON:** Every quarter Maya buys a handful of these. The expert always talks; the clock always wins; the question she needed hits her in the parking lot. Brooks is the analyst in her ear that never forgets the model and never loses the time.
...
> **SKYLER:** Brooks ships inside Multiplier, to funds already paying us. Buy the hour. Don't waste it.
...
- **Genuinely live:** STT, Moss ingestion + retrieval, and Brooks's surfacing all run live. That's the proof
...
| Criterion | v1 (earnings/Brooks) | v2 (this) |
|---|---|---|
